...
begin
    ...
    uGlobal.gsPathDataBase := ExtractFilePath(Application.Exename) + 'Dados';
    tblChamadas.DatabaseName := uGlobal.gsPathDataBase;
    tblAtend.DatabaseName := uGlobal.gsPathDataBase;
    tblClientes.DatabaseName := uGlobal.gsPathDataBase;
    tblClientesGrid.DatabaseName := uGlobal.gsPathDataBase;
    tblTecnicos.DatabaseName := uGlobal.gsPathDataBase;
